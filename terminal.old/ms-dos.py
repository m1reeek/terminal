...
class MSDOSTerminal:
    ...
    def print_help_message(self):
        print("Welcome to the MSDOS Terminal!")
    ...
    def run_pms_script(self, command):
        ...
        if os.path.isfile(script_file):
            try:
                ...
                # Backup the current stdin and stdout
                self.stdin_backup = sys.stdin
                self.stdout_backup = sys.stdout
                self.stderr_backup = sys.stderr
                # Redirect stdin and stdout to StringIO
    ...
    def save_file(self):
        if not self.current_command.endswith(".pms"):
            print("Please provide a file name with the '.pms' extension.")
            print()
            return
